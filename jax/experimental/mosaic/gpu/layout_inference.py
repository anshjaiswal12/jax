...
class DerivationContext:
  ...
  #
  # Concretely, if a memory slice op shares the same base address, `alias_id`
  # with another memory slice op, then they are considered to be the same ref
  # and must have the same layout. Otherwise, they are independent.
